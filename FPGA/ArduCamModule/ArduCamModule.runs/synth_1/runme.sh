...
HD_PWD='C:/Users/Gogol/Desktop/ClassWork/EE175/FPGA/ArduCamModule/ArduCamModule.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CameraController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CameraController.tcl
